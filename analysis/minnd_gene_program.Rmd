---
title: "Gene program analysis for MINND"
author: "Lifan Liang"
date: "2026-06-27"
...
After obtaining the "usage" matrix from matrix factorization, we first normalized the usage across programs such that the usage for each sample sums up to one. And then we standardize the usage across samples such that it has mean=0 and std=1. Finally, we regressed all the perturbation on the loadings for each program with the following formula in `lmer`:
